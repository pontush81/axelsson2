...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_f6f2a62d.png)
Du får en översikt över de anställda som har en tidrapport som ska attesteras och dess status.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_3e282d42.png)
Klicka på en rad för att se detaljposter om tidrapporten och för att attestera eller avslå.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_fefb459b.png)
Attestering av reseräkningar
På samma sätt som för tidrapporten indikerar ikonen med en siffra om det finns några reseräkningar att attestera.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_d7c20a52.png)
En lista med reseräkningar som ska attesteras och deras status visas när du öppnar funktionen.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_b0a1c642.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_379780bb.png)
Delattestering av tidrapportstransaktioner
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_7f1f91f7.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_42926379.png)
Klickar du på
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_fa0c5684.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_404d32bb.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_04e44469.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_88b0962f.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_be130099.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_2a71ef9d.png)
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_177c2fbc.png)
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_6ca124e7.png)
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_5aa8fb53.png)
En informationsruta visas när delattesten är klar.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_a8a2afd9.png)
Delattestering av reseräkningstransaktioner
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_88b79041.png)
En siffra i den röda cirkeln i övre högra hörnet indikerar antalet reseräkningar och/eller transaktioner att granska.
Har du mer än en granskningsbehörighet visas ett val när du klickar på ikonen.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_edba2831.png)
Klickar du på
Delattestering reseräkningar
kommer du till en översiktsvy där varje projekts timmar visas summerat per projekt. Endast klarmarkerade tider inom det valda datumintervallet kommer att visas.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_0624fa9c.png)
De anställda som har rapporterat resetransaktioner mot ditt projekt listas när du klickar på en projektrad.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_fee854a1.png)
Beviljande av frånvaro
...
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_1236ba0a.png)
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_10b01507.png)
En lista över alla frånvaroansökningar visas, klicka på den du vill behandla.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_e22db464.png)
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_92c4e1e2.png)
Registrera frånvaro på en annan anställd
Du kan även registrera frånvaro på en annan anställd via Flex Mobile.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_68e038eb.png)
Under meny-knappen kan du välja anställd.
![Bild](images/administrativa-funktioner-vilka-administrativa-funktioner-kan-jag-styra-direkt-i-mobilen_f82d548c.png)
