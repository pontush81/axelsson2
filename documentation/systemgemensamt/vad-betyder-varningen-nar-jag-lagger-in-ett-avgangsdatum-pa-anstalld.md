...
**Tags:** roll  
**Bilder:** 3  
**URL:** https://knowledge.flexapplications.se/varning-avg%C3%A5ngsdatum
...
![Bild](images/vad-betyder-varningen-nar-jag-lagger-in-ett-avgangsdatum-pa-anstalld_370aa4dc.png)
HRM Time
Om ni som företag har HRM Time får du upp följande fråga när du sparar ett avgångsdatum på en anställd:
![Bild](images/vad-betyder-varningen-nar-jag-lagger-in-ett-avgangsdatum-pa-anstalld_2ba3a8d1.png)
...
![Bild](images/vad-betyder-varningen-nar-jag-lagger-in-ett-avgangsdatum-pa-anstalld_3b517c73.png)
Kryssar du i rutan svarar du
JA
