...
![Bilden visar "Skapa fil"-fönstret med val att bocka i rutan för "Rättelse av uppgifter".](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_243f14f3.png)
Detta gör att extra fält för urval av anställda att ta med i filen kommer fram.
![Bilden visar urvalsmöjligheterna vid skapandet av en rättelsefil. ](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_ff0c53f4.png)
...
![Bilden visar ett exempel på bruttoskuld som uppstått för en anställd.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_f6a12a67.png)
...
![Bilden visar detaljinformation i arbetsgivardeklarationen på individnivå för en anställd.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_87b76b76.png)
![Bilden visar utdrag från en anställds lönespecifikation.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_0aa3230f.png)
![Bilden visar översikten för en anställd i arbetsgivardeklarationen på individnivå, där underlaget är kontrollmarkerat.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_adefdcc1.png)
...
![Bilden visar ett exempel på skapande av en extra lönekörning.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_e787d8f6.png)
...
![Bild](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_f3c943b3.png)
...
![Bild visar översikten i arbetsgivardeklarationen.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_ef98cbf6.png)
![Bilden visar detaljinformationen för en anställd i arbetsgivardeklarationen.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_8a4c06fb.png)
...
![Bilden fälten för att skapa fil med rättelse och urval på en anställd markerade.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_7cd8ad07.png)
...
![Bilden visar urvalen för att skapa en extra lönekörning.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_8c661812.png)
Ta ut en ny Arbetsgivardeklaration på individnivå och skicka in rättelsen.
![Bilden visar urval för att skapa rättelsefil för arbetsgivardeklarationen med urval på en anställd.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_e5528c6d.png)
