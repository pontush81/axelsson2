...
![Bilden visar inställningsfälten för Danske Banks filformat..](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_6fcc0948.png)
...
![Bilden visar Handelsbankens inställningsfält för filformat och registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_74e4de34.png)
Text på kontoutdraget
Du kan här välja vilken text som ska komma med på den anställdes kontoutdrag. Observera att detta inte kommer fungera fullt ut innan Bankgirocentralens nya betalinfrastruktur på på plats och banken har stöd för hanteringen. Kontakta din bank för mer information.
Från vilket konto ska lön betalas ut?
...
![Bilden visar Nordeas inställningsfält för filformat samt registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_0d021340.png)
Text på kontoutdraget
Du kan här välja vilken text som ska komma med på den anställdes kontoutdrag. Observera att detta inte kommer fungera fullt ut innan Bankgirocentralens nya betalinfrastruktur på på plats och banken har stöd för hanteringen. Kontakta din bank för mer information.
Från vilket konto ska lön betalas ut?
...
![Bilden visar SEBs inställningsfält för filformat samt registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_032d95b1.png)
Text på kontoutdraget
Du kan här välja vilken text som ska komma med på den anställdes kontoutdrag. Observera att detta inte kommer fungera fullt ut innan Bankgirocentralens nya betalinfrastruktur på på plats och banken har stöd för hanteringen. Kontakta din bank för mer information.
Från vilket konto ska lön betalas ut?
...
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_89eac607.png)
Du som använder tjänsten ISO LB anger ett Bankgironummer som lönerna ska betalas ut från.
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_f8f26c70.png)
Identifikation hos banken
...
![Bilden visar Swedbanks inställningsfält för filformat och registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_b0a00709.png)
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_588a1e88.png)
Identifikation hos banken
...
![Bilden visar JP Morgans inställningsfält för filformat samt registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_9bbbdbbb.png)
Text på kontoutdraget
Du kan här välja vilken text som ska komma med på den anställdes kontoutdrag. Observera att detta inte kommer fungera fullt ut innan Bankgirocentralens nya betalinfrastruktur på på plats och banken har stöd för hanteringen. Kontakta din bank för mer information.
Från vilket konto ska lön betalas ut?
...
![Bilden visar BNP Paribas inställningsfält för filformat samt registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_869302b5.png)
Tillåt endast A-Z
...
![Bilden visar DNBs inställningsfält för filformat samt registerinformation.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_e10c75cf.png)
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_5234108d.png)
Identifikation hos banken
...
![Bilden visar att "Annan bank" är valt i inställningsfältet för bank och filformat.](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_5a4ab476.png)
Följande inställningar kan göras. Benämningarna motsvarar de som används i ISO-formatet.
![Bilden visar fälten "Requested execution date" och "Batchbooking".](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_624c992b.png)
...
Initiating Party
![Bilden visar fälten för "Initiating Party Id Code" och "Initiating Party Id".](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_3d560e8b.png)
...
Debtor
![Bilden visar fälten "Debtor Id Code" och "Debtor Id".](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_0d6e9497.png)
Debtor Id Code
Här anger du den kod som banken önskar, vanligtvis BANK eller CUST.
Debtor Id
Här anger du det ID som ska användas för identifiering i Debtor.
Debtor Account
![Bilden visar fälten "BIC-kod" och "IBAN-nummer".](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_a8e40a89.png)
Här anger du IBAN-nummer och BIC-kod för det bankkonto som utbetalning ska göras från.
Creditor
![Bilden visar fälten under Creditor: Fält "IBAN (internationella bankkontoformatet)" som ej är valbart,  fält "Tillåt endast A-Z" och fält "Text på kontoutdraget".](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_25ae0b00.png)
...
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_7044cf48.png)
...
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_a919bea3.png)
![Bild](images/hur-gor-jag-installningar-for-bankfiler-med-formatet-iso-20022-pain-001-xml-i-hrm-payroll_7d16a527.png)
Ordlista
P27
