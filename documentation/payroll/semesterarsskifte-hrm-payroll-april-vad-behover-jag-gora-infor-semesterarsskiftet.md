...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_948c7b65.png)
Klicka på
Beräkna
.
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_1b7544bc.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_628f40b6.png)
När du klickar på
Skapa
skapas ett underlag som du sedan kan gå igenom och kontrollera.
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_e1f83bb1.png)
När du scrollar till höger i underlaget ser du alla de parametrar som ligger till grund för semesterberäkningen.
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_37173b44.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_94cafc6f.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_8edc2c1f.png)
...
Före utbetalning:
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_21c838fd.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_b1d958ba.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_65544f28.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_2b201351.png)
Gå nu tillbaka till
Semesterårsskifte
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_59b92153.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_5c7785e4.png)
...
![Bilden visar översikten av en importmall för löpande import av transaktioner.](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_87cffb17.png)
Importfil
Ladda sen ner semesterskifteslistan i Excel för att skapa en importfil.
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_97ced667.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_7f24bd73.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_6b307523.png)
Du behöver sen ta bort den anställdes namn i kolumn A så att endast anställningsnummer kvarstår.
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_b422c06d.png)
Spara slutligen filen som en kommaavgränsad fil.
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_b888b352.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_d3eec366.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_d21182ca.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-april-vad-behover-jag-gora-infor-semesterarsskiftet_6508d5f1.png)
