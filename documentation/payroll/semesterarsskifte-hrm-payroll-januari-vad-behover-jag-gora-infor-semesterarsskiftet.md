...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_9acb2ac9.png)
Klicka på
Beräkna
.
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_137d06a4.png)
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_b97aac2d.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_43b14f7a.png)
När du klickar på
Skapa
skapas ett underlag som du sedan kan gå igenom och kontrollera.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_628694e2.png)
I översikten av underlaget finns alla de parametrar som ligger till grund för semesterberäkningen.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_cab22e0a.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_5d121e64.png)
I kolumnerna i den
högra
delen av vyn kan du även se vilka dagar som systemet varnar för.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_3dbdd814.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_af66b63c.png)
...
Före utbetalning:
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_3d2b0852.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_ab1cfe06.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_65544f28.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_9e45dc60.png)
Gå nu tillbaka till
Semesterårsskifte
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_59b92153.png)
När allt är klart klickar du på
Verkställ underlag
och semesterårsskiftet är klart.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_9e768b19.png)
De anställda har nu fått sina nya dagar som du kan se både i anställdaregistret och i löneberedningen.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_43048b2f.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_e81f175d.png)
...
![Bilden visar översikten av en importmall för löpande import av transaktioner.](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_87cffb17.png)
Importfil
Ladda sen ner semesterskifteslistan i Excel för att skapa en importfil.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_97ced667.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_9ed76470.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_57fe3a71.png)
Du behöver sen ta bort den anställdes namn i kolumn A så att endast anställningsnummer kvarstår.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_2387620b.png)
Spara slutligen filen som en kommaavgränsad fil.
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_6abb09b8.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_495ac99d.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_273165b8.png)
...
![Bild](images/semesterarsskifte-hrm-payroll-januari-vad-behover-jag-gora-infor-semesterarsskiftet_ffdb38d7.png)
