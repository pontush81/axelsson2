...
.
![Bilden visar översikten av funktionen att skicka arbetsgivarintyg.](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_492f8a9b.png)
Urval anställda
...
![Bilden visar olika fält där man kan göra urval på anställda.](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_29d94624.png)
![Bilden visar en lista vilka vad man kan göra för att ange varifrån systemet ska hämta informationen om arbetad tid. Det finns tre val.](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_62baf119.png)
...
![Bilden visar datumfölt för den period man vill ta ut arbetsgivarintyg för; ett fr o m -och ett t o m-fält](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_1fd9c533.png)
...
![Bilden visar de fält som gäller för företagets uppgifter.](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_b678fd7c.png)
Skicka in underlag
När alla urval är ifyllda klickar du på knappen för att skicka underlaget till arbetsgivarintyg.nu.
![Bild](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_e2237eb9.png)
...
![Bild](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_e8cb4142.png)
...
![Bild](images/hur-skapar-jag-ett-arbetsgivarintyg-i-flex-hrm-payroll_59400faf.png)
Relaterade artiklar:
