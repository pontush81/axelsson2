...
.
![Bilden visar översikt av ett underlag för lönestrukturstatistiken.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_0a3676f9.png)
Skapa underlag
...
Ny
i knappraden.
![Knappen Ny visas markerad.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_e38754b7.png)
...
![Bilden visar ruta med urvalsmöjligheter vis skapande av nytt underlag för lönestrukturstatistik.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_e32f4016.png)
...
Preliminär
i vyn.
![Bilden visar fältet status där status visas som "Preliminär".](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_b625bb89.png)
Ta bort underlag
...
![Bilden visar Ta bort-knappen.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_80a23938.png)
...
![Bilden visar fälten för redovisningsperiod och fältet där man se tför vilken statistik uppgifterna ska skickas till.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_14a0f21d.png)
...
![Bilden visar översikten av ett underlag där man ser olika kolumner för olika värden.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_c336ff8f.png)
Du kan också exportera underlaget till Excel genom att klicka på knappen
Excel
i knappraden.
![Bilden visar knappen för att exportera underlaget till Excel..](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_32ce16e7.png)
När underlaget är granskat markerar du underlaget som kontrollerat genom att klicka på knappen
Markera som kontrollerad
.
![Bilden visar knappen "Markera som kontrollerad".](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_2687c41f.png)
Underlaget får då statusen
Kontrollerad
. Systemet sparar även datum, tid och användarsignatur för den som genomfört kontrollmarkeringen.
![Bilden visar fälten för status, datum och tid samt signatur.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_d69e754f.png)
...
![Bilden visar knappen "Ta bort".](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_a241f9de.png)
Fil för redovisning
...
Visa filer
i knappraden.
![Bilden visar knappen för att visa filer.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_a95a1596.png)
...
![Bilden visar listan över skapade underlag med filer.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_2b1bb5b8.png)
Relaterade artiklar:
Hur beräknas underlaget för lönestrukturstatistik för privat sektor (SLP)?
