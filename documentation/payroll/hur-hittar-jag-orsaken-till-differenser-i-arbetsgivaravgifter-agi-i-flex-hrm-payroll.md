...
![Bilden visar översikten i AGIn med röd markering på en rad.](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_6b28b55b.png)
Genom att klicka på
den röda bollen
får vi upp följande information om att det är arbetsgivaravgiften som inte stämmer.
![Meddelanderuta som beskriver vad som inte stämmer.](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_4e60db22.png)
Till höger kan vi se vilka belopp som redovisas per fält.
![Bilden visar detaljvisningen för fälten i arbetsgivardeklarationen.](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_f8eb46c1.png)
...
![Bild](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_6c7e1e8b.png)
Exportera rapporten till Excel.
![Bild](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_acd9bb2f.png)
Vi får då ut följande i Excel:
![Bild](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_b3cbf915.png)
...
![Bild](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_d87ff2aa.png)
...
![Bild](images/hur-hittar-jag-orsaken-till-differenser-i-arbetsgivaravgifter-agi-i-flex-hrm-payroll_15753991.png)
Relaterade artiklar:
