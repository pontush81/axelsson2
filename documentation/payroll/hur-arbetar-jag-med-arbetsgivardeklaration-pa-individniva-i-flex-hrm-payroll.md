...
![Bilden visar fälten Redovisningsperiod (sökbart), Status, Datum och tid samt Signatur i arbetsgivardeklarationen..](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_4d321bf9.png)
Redovisningsperiod
...
![Bilden visar översikten för arbetsgivardeklaration på individnivå (AGI).](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_9829dedb.png)
...
![Bilden visar sökfältet.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_cb9e6fdc.png)
...
![Bilden visar detaljvyn i arbetsgivardeklarationen på individnivå (AGI).](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_ca93d395.png)
...
![Bilden visar summeringarna för huvuduppgifterna för arbetsgivardeklarationen på individnivå. ](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_23f27757.png)
Skapa underlag
...
Skapa
.
![Bilden visar dialogruta där man skapar nytt underlag för arebtsgivardeklaration på individnivå.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_cb6c70a3.png)
Specifikationsnummer
...
![Bilden visar Komplettera-knappen i menyn.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_e3097ecb.png)
...
![Bild visar varning.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_be7329b6.png)
...
![Bild visar varning.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_87018b17.png)
...
![Bild visar varning.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_693caac9.png)
...
![Bilden visar kolumnen Status i översikten,](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_d8e496a2.png)
...
Excel
.
![Bild visar Excel-knappen ovanför översikten för arbetsgivarintyg på individnivå.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_2d2dfab7.png)
...
![Bilden visar knappen för "Markera som kontrollerad".](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_4c20379a.png)
...
![Bilden visar fälten Status, Datum och tid samt Signatur.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_2f0ee086.png)
...
![Bilden visar knappen för att exportera underlaget till Excel.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_b1dbb876.png)
...
![Bilden visar knappen "Direktinlämning".](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_d13e0490.png)
...
Fortsätt
.
![Bilden visar informationsruta angående autentisering hos skatteverket.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_0c5c0b38.png)
Följ därefter instruktionerna för att logga in på Skatteverket.
![Bilden visar inloggning på skatteverkets hemsida.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_af658d2f.png)
...
![Bild visar vaket att godkänna att uppgifterna skickas in till Skatteverket.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_24283677.png)
Därefter kommer du tillbaka till Flex HRM där du kan fortsätta med själva inskickandet av arbetsgivardeklarationen.
![Bilden visar dialogruta för direktinlämning där man fyller i uppgifterna för teknisk kontaktperson.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_6a6d9539.png)
...
![Bilden visar bekräftelseruta för inlämnad arbetsgivardeklaration.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_0ef69376.png)
...
.
![Bild](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_51004370.png)
...
![Bilden visar meddelande om att inlämning avvisades.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_da569b2c.png)
...
![Bilden visar knappen "Visa inlämningar".](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_a30535eb.png)
![Bilden visar översikten för inlämningar för aktuell period med filen och eventuella felloggar.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_11cd9f73.png)
...
![Bilden visar knappen "Skapa fil".](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_e3d93b3b.png)
När du klickar på knappen
Skapa fil
i knappraden öppnas följande dialog:
![Bilden visar ruta med information om teknisk kontaktperson.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_b8940bef.png)
...
![Bild visar notiser med information om status för skapande av fil för arbetsgivardeklaration.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_ea12e56d.png)
...
![Bilden visar notiser med information om status och om eventuella fel har upptäckts.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_85251f26.png)
...
![Bilden visar knappen "Visa filer".](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_2e8d7d3f.png)
![Bilden visar filer och felloggar för perioden.](images/hur-arbetar-jag-med-arbetsgivardeklaration-pa-individniva-i-flex-hrm-payroll_9daafb06.png)
Se
