...
**Bilder:** 10  
**URL:** https://knowledge.flexapplications.se/kalendarium-hur-kan-jag-se-en-sammanst%C3%A4llning-av-fr%C3%A5nvaro-och-schematid-f%C3%B6r-en-anst%C3%A4lld
...
Kalendarium
i sidomenyn.
![Bilden visar menyvalet för Kalendarium](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_62e3b9b3.png)
Du får då upp följande vy:
![Bilden visar översikten för Kalendarium med kolumner för varje månad.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_895aaeda.png)
...
![Bilden visar fältet Anställd med pilar på varje sida för att bläddra mellan anställda.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_95cb68d1.png)
Datumintervall
Ange det datumintervall du vill visa kalendern för. Klicka på
uppdateringsikonen
för att uppdatera vyn efter varje ändring av datum.
![Bilden visar fälten för datumurval.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_cfc31536.png)
Visa schematid
Markera rutan
Visa schematid
...
![Bilden visar rutan "Visa schematid" som ör markerad.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_5aa5d97c.png)
Filter
Med funktionen
Filter
kan du ange ett urval av anställda som du vill arbeta med i kalendariet.
![Bilden visar filter-symbolen till höger om fältet för anställda.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_59325232.png)
...
![Bilden visar urvalsmöjligheterna för filterfunktionen; olika fält för urval.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_0d733c81.png)
...
![Bilden visar muspekaren hovrande över en dag med frånvaro som visar detaljerna om frånvaron.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_ff5dc445.png)
...
![Bild](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_95d1024b.png)
Klicka på
Dölj summering
...
![Biden visar fältet för visa summering som fälls ut när man klickat på "Visa summering".](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_f1975d1e.png)
