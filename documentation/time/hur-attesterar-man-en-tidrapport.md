...
Status
.
![Menyn Status, med undermenyerna Ta bort klarmarkering och Attestera dagar.](images/hur-attesterar-man-en-tidrapport_3bfa391d.png)
eller via översiktsvyn som nås via menyn
Attestering
:
![Sidomenyn - Klocka - Attestering.](images/hur-attesterar-man-en-tidrapport_8535e3c8.png)
Observera
...
Ersättningar
.
![Attestering av tidrapporter. Till vänster en lista med två rader. En rad är markerad. Till höger visas alla periodens dagar grafiskt, med färgade rader för schema, arbetad tid, frånvaro.](images/hur-attesterar-man-en-tidrapport_658e540c.png)
Högst upp visas information om avvikelser, ospecificerad tid och saldon för hela perioden.
![Attesteringsvy. Summering av period. Det finns en avvikelse för frånvaro och summor för schematid, närvaro och frånvaro](images/hur-attesterar-man-en-tidrapport_d101ec3d.png)
För varje dag visas information på samma vis som för hela perioden plus detaljer kring hur den rapporterade tiden ser ut.
![Attesteringsvy. Tre rader med grafiska tidrader (visar schema, närvaro, frånvaro, rast med färger), samt dagsaldon.](images/hur-attesterar-man-en-tidrapport_05607925.png)
...
![Popup visar tidkoder, klockslag och konteringar för en dag.](images/hur-attesterar-man-en-tidrapport_6769a330.png)
Frånvaro:
![Popup visar att en dag har sjukfrånvaro.](images/hur-attesterar-man-en-tidrapport_79207d1a.png)
Schematid:
![Popup visar schematid.](images/hur-attesterar-man-en-tidrapport_dde869f5.png)
...
![Fliken Ersättningar har en asterisk. “Visa genererade rader” är ibockad.](images/hur-attesterar-man-en-tidrapport_3c6d8681.png)
...
![Kryssrutor för Klarmarkering och Attestering, signatur, info-ikon.](images/hur-attesterar-man-en-tidrapport_a2f76365.png)
...
![Bild](images/hur-attesterar-man-en-tidrapport_b83b6032.png)
Gruppering i granskningsvy per dag
...
![Attesteringsvy grupperad per vecka. 3 rader veckor visas, en är utfälld och visar en rad för varje enskild dag.](images/hur-attesterar-man-en-tidrapport_624d0db3.png)
