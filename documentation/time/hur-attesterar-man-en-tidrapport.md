...
Status
.
![Menyn Status, med undermenyerna Ta bort klarmarkering och Attestera dagar.](images/hur-attesterar-man-en-tidrapport_61f7ecc7.png)
eller via översiktsvyn som nås via menyn
Attestering
:
![Sidomenyn - Klocka - Attestering.](images/hur-attesterar-man-en-tidrapport_a35b7876.png)
Observera
...
Ersättningar
.
![Attestering av tidrapporter. Till vänster en lista med två rader. En rad är markerad. Till höger visas alla periodens dagar grafiskt, med färgade rader för schema, arbetad tid, frånvaro.](images/hur-attesterar-man-en-tidrapport_79cb9f90.png)
Högst upp visas information om avvikelser, ospecificerad tid och saldon för hela perioden.
![Attesteringsvy. Summering av period. Det finns en avvikelse för frånvaro och summor för schematid, närvaro och frånvaro](images/hur-attesterar-man-en-tidrapport_6f1717ae.png)
För varje dag visas information på samma vis som för hela perioden plus detaljer kring hur den rapporterade tiden ser ut.
![Attesteringsvy. Tre rader med grafiska tidrader (visar schema, närvaro, frånvaro, rast med färger), samt dagsaldon.](images/hur-attesterar-man-en-tidrapport_5e9edd92.png)
...
![Popup visar tidkoder, klockslag och konteringar för en dag.](images/hur-attesterar-man-en-tidrapport_694e1ab1.png)
Frånvaro:
![Popup visar att en dag har sjukfrånvaro.](images/hur-attesterar-man-en-tidrapport_7ac495e4.png)
Schematid:
![Popup visar schematid.](images/hur-attesterar-man-en-tidrapport_798e8773.png)
...
![Fliken Ersättningar har en asterisk. “Visa genererade rader” är ibockad.](images/hur-attesterar-man-en-tidrapport_80a20f59.png)
...
![Kryssrutor för Klarmarkering och Attestering, signatur, info-ikon.](images/hur-attesterar-man-en-tidrapport_25c71b35.png)
...
![Bild](images/hur-attesterar-man-en-tidrapport_b3d400ea.png)
Gruppering i granskningsvy per dag
...
![Attesteringsvy grupperad per vecka. 3 rader veckor visas, en är utfälld och visar en rad för varje enskild dag.](images/hur-attesterar-man-en-tidrapport_946de10d.png)
