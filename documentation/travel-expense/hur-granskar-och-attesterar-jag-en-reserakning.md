...
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_4ba376c3.png)
…eller via en översiktsvy över det som ska attesteras som finns under menyn Attestering:
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_bfe16d81.png)
I denna listas alla reseräkningar som matchar de kriterier som ställts in i filtreringsfunktionen:
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_bfb87721.png)
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_5dd625a2.png)
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_327a791d.png)
Använd med fördel snabbknapparna för varje reseräkning för att (sett från vänster):
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_0b95a78b.png)
...
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_aa353d6b.png)
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_fd71e1cd.png)
Avslå reseräkning
Med denna knapp kan du när du håller muspekaren över Status-knappen avslå aktuell reseräkning direkt på reseräkningen.
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_58f25018.png)
När man avslår reseräkningen måste man ange en orsak.
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_372375f3.png)
Meddelandet syns på reseräkningen, och den anställde kan få notis om detta via påminnelser.
![Bild](images/hur-granskar-och-attesterar-jag-en-reserakning_95b4d690.png)
